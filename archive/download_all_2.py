...
Path("../DOWNLOADS/inventory").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/management").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/platforms").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/cloud").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/interfaces").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/cdp-lldp").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/port-channels").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/vlans").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/spanning-tree").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/addressing").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/fhrp").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/networks").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/routing").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/mpls").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/multicast").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/management").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/security").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/load-balancing").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/wireless").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/voip").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/sdn").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/sdwan").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/qos").mkdir(parents=True, exist_ok=True)
Path("../DOWNLOADS/technology/oam").mkdir(parents=True, exist_ok=True)
...
for device in devices:
    ...
    if config:
        with open('DOWNLOADS/configs/' + device['hostname'] + '.txt', 'w') as file:
            print(f"Config file downloaded for: {device['hostname']}")
            file.write(config.text)
    else:
        print(f"Missing Config {device['hostname']}")
    if device['taskKey']:
        with open('DOWNLOADS/logs/' + device['hostname'] + '.txt', 'w') as file:
...
df.to_csv('DOWNLOADS/inventory/sites.csv')
...
df.to_csv('DOWNLOADS/inventory/devices.csv')
...
df.to_csv('DOWNLOADS/inventory/devices-models.csv')
...
df.to_csv('DOWNLOADS/inventory/devices-platforms.csv')
...
df.to_csv('DOWNLOADS/inventory/devices-families.csv')
...
df.to_csv('DOWNLOADS/inventory/devices-vendors.csv')
...
df.to_csv('DOWNLOADS/inventory/part-numbers.csv')
...
df.to_csv('DOWNLOADS/inventory/os-versions.csv')
...
df.to_csv('DOWNLOADS/inventory/interfaces.csv')
...
df.to_csv('DOWNLOADS/inventory/hosts.csv')
...
df.to_csv('DOWNLOADS/inventory/end-of-life-milestones.csv')
...
df.to_csv('DOWNLOADS/inventory/end-of-life-milestones-detail.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/cluster-srx.csv')
...
df.to_csv('DOWNLOADS//technology/platforms/fex-modules.csv')
...
df.to_csv('DOWNLOADS//technology/platforms/fex-modules-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/vss-chassis.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/vss-vsl.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/poe-devices.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/poe-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/poe-modules.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/stacks.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/stacks-members.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/stacks-connections.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/power-supplies.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/power-supplies-fans.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/fans.csv')
...
df.to_csv('DOWNLOADS/technology/platforms/modules.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/interfaces/load'))
df.to_csv('DOWNLOADS//technology/interfaces/current-rates-inbound.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/interfaces/load'))
df.to_csv('DOWNLOADS//technology/interfaces/current-rates-outbound.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/interfaces/load'))
df.to_csv('DOWNLOADS//technology/interfaces/current-rates-bidirectional.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-inbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-outbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-bidirectional.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-inbound-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-outbound-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-data-rates-bidirectional-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-inbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-outbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-bidirectional.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-inbound-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-outbound-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-error-rates-bidirectional-device.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-inbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-outbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-bidirectional.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-inbound-devices.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-outbound-devices.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/average-drop-rates-bidirectional-devices.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/duplex-mismatch.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/errdisabled.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/connectivity-matrix.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/unmanaged-neighbors-summary.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/unmanaged-neighbors-details.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/switchports.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/mtu.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/storm-control-broadcast.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/storm-control-unicast.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/storm-control-multicast.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/storm-control-all-traffic.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/transceivers-inventory.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/transceivers-statistics.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/transceivers-thresholds.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/transceivers-errors.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/pppoe-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/pppoe-sessions.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/counters-inbound.csv')
...
df.to_csv('DOWNLOADS/technology/interfaces/counters-outbound.csv')
...
df.to_csv('DOWNLOADS/technology/cdp-lldp/all-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/cdp-lldp/unmanaged-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/cdp-lldp/unidirectional-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/inbound-balancing-table.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/outbound-balancing-table.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/member-status-table.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/mlag-vpc.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/mlag-switches.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/mlag-peers.csv')
...
df.to_csv('DOWNLOADS/technology/port-channels/mlag-pairs.csv')
...
df.to_csv('DOWNLOADS/technology/vlans/device-summary.csv')
...
df.to_csv('DOWNLOADS/technology/vlans/device-detail.csv')
...
df.to_csv('DOWNLOADS/technology/vlans/network-summary.csv')
...
df.to_csv('DOWNLOADS/technology/vlans/site-summary.csv')
...
df.to_csv('DOWNLOADS/technology/vlans/l3-gateways.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-stability.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-bridges.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-instances.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-vlans.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-virtual-ports.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-guards.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-inconsistencies.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-neighbor-ports-vlan-mismatch.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-ports-multiple-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-cdp-ports-mismatch.csv')
...
df.to_csv('DOWNLOADS/technology/spanning-tree/stp-multiple-stp.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/arp-table.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/mac-table.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/managed-ip.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/duplicate-ip.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/nat-rules.csv')
...
df.to_csv('DOWNLOADS/technology/addressing/nat-pools.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/group-state.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/group-members.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/active-gw-root-alignment.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/active-gw-balancing.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/glbp-forwarders.csv')
...
df.to_csv('DOWNLOADS/technology/fhrp/virtual-gateways.csv')
...
df.to_csv('DOWNLOADS/technology/networks/managed-networks.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/networks'))
df.to_csv('DOWNLOADS/technology/networks/gateway-redundancy.csv')
...
df.to_csv('DOWNLOADS/technology/networks/summary-protocols.csv')
...
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-bgp.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/networks/summary/protocols'))
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-eigrp.csv')
...
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-isis.csv')
...
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-ospf.csv')
...
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-ospfv3.csv')
...
df = pd.json_normalize(ipf.fetch_all('tables/networks/summary/protocols'))
df.to_csv('DOWNLOADS/technology/networks/summary-protocols-rip.csv')
...
df.to_csv('DOWNLOADS/technology/routing/routes.csv')
...
df.to_csv('DOWNLOADS/technology/routing/route-stability.csv')
...
df.to_csv('DOWNLOADS/technology/routing/ospf-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/ospf-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/routing/ospf-v3-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/ospf-v3-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/routing/bgp-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/bgp-address-families.csv')
...
df.to_csv('DOWNLOADS/technology/routing/eigrp-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/eigrp-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/routing/rip-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/rip-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/routing/is-is-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/routing/is-is-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/routing/path-verifications.csv')
...
df.to_csv('DOWNLOADS/technology/routing/vrf-summary.csv')
...
df.to_csv('DOWNLOADS/technology/routing/vrf-detail.csv')
...
df.to_csv('DOWNLOADS/technology/routing/vrf-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/ldp-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/ldp-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/mpls-forwarding.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l3vpn-pe-routers.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l3vpn-pe-vrfs.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l3vpn-vrf-targets.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l2vpn-point-to-point-vpws.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l2vpn-point-to-multipoint.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/l2vpn-circuit-cross-connect.csv')
...
df.to_csv('DOWNLOADS/technology/mpls/pseudowires.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/pim-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/pim-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-overview.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-table.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-outgoing-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-counters.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-first-hop-router.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/mroute-sources.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/igmp-groups.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/igmp-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/igmp-snooping-global.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/igmp-snooping-vlans.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/igmp-snooping-groups.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/macs.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/rp-overview.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/rp-bsr.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/rp-mappings.csv')
...
df.to_csv('DOWNLOADS/technology/multicast/rp-mappings-groups.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-servers.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-lines.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-authentication.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-authorization.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-accounting.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-users.csv')
...
df.to_csv('DOWNLOADS/technology/management/aaa-password-strength.csv')
...
df.to_csv('DOWNLOADS/technology/management/telnet-access.csv')
...
df.to_csv('DOWNLOADS/technology/management/saved-config-consistency.csv')
...
df.to_csv('DOWNLOADS/technology/management/ntp-summary.csv')
...
df.to_csv('DOWNLOADS/technology/management/ntp-sources.csv')
...
df.to_csv('DOWNLOADS/technology/management/port-mirroring.csv')
...
df.to_csv('DOWNLOADS/technology/management/logging-summary.csv')
...
df.to_csv('DOWNLOADS/technology/management/logging-remote.csv')
...
df.to_csv('DOWNLOADS/technology/management/logging-local.csv')
...
df.to_csv('DOWNLOADS/technology/management/flow-overview.csv')
...
df.to_csv('DOWNLOADS/technology/management/netflow-flow-devices.csv')
...
df.to_csv('DOWNLOADS/technology/management/netflow-collectors.csv')
...
df.to_csv('DOWNLOADS/technology/management/netflow-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/management/sflow-devices.csv')
...
df.to_csv('DOWNLOADS/technology/management/sflow-collectors.csv')
...
df.to_csv('DOWNLOADS/technology/management/sflow-sources.csv')
...
df.to_csv('DOWNLOADS/technology/management/snmp-summary.csv')
...
df.to_csv('DOWNLOADS/technology/management/snmp-communities.csv')
...
df.to_csv('DOWNLOADS/technology/management/snmp-trap-hosts.csv')
...
df.to_csv('DOWNLOADS/technology/management/snmp-users.csv')
...
df.to_csv('DOWNLOADS/technology/management/ptp-local-clock.csv')
...
df.to_csv('DOWNLOADS/technology/management/ptp-masters.csv')
...
df.to_csv('DOWNLOADS/technology/management/ptp-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/management/licenses-summary.csv')
...
df.to_csv('DOWNLOADS/technology/management/licenses.csv')
...
df.to_csv('DOWNLOADS/technology/management/licenses-detail.csv')
...
df.to_csv('DOWNLOADS/technology/management/smartnet-authorization.csv')
...
df.to_csv('DOWNLOADS/technology/management/smartnet-registration.csv')
...
df.to_csv('DOWNLOADS/technology/management/smartnet-reservations.csv')
...
df.to_csv('DOWNLOADS/technology/security/acl-global-policies.csv')
...
df.to_csv('DOWNLOADS/technology/security/acls.csv')
...
df.to_csv('DOWNLOADS/technology/security/acl-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/security/dmvpn.csv')
...
df.to_csv('DOWNLOADS/technology/security/dhcp-snooping.csv')
...
df.to_csv('DOWNLOADS/technology/security/dhcp-bindings.csv')
...
df.to_csv('DOWNLOADS/technology/security/ipsec-tunnels.csv')
...
df.to_csv('DOWNLOADS/technology/security/ipsec-gateways.csv')
...
df.to_csv('DOWNLOADS/technology/security/secure-ports-devices.csv')
...
df.to_csv('DOWNLOADS/technology/security/secure-ports-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/security/secure-ports-users.csv')
...
df.to_csv('DOWNLOADS/technology/security/zone-firewall-policies.csv')
...
df.to_csv('DOWNLOADS/technology/security/zone-firewall-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/load-balancing/virtual-servers.csv')
...
df.to_csv('DOWNLOADS/technology/load-balancing/virtual-servers-pools.csv')
...
df.to_csv('DOWNLOADS/technology/load-balancing/virtual-servers-pool-members.csv')
...
df.to_csv('DOWNLOADS/technology/load-balancing/f5-partitions.csv')
...
df.to_csv('DOWNLOADS/technology/wireless/controllers.csv')
...
df.to_csv('DOWNLOADS/technology/wireless/access-points.csv')
...
df.to_csv('DOWNLOADS/technology/wireless/radios-detail.csv')
...
df.to_csv('DOWNLOADS/technology/wireless/ssid-summary.csv')
...
df.to_csv('DOWNLOADS/technology/wireless/clients.csv')
...
df.to_csv('DOWNLOADS/technology/voip/phones.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/aci-endpoint.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/aci-vlan.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/aci-vrf.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/aci-dtep.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/vxlan-vtep.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/vxlan-peers.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/vxlan-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/sdn/vxlan-vni.csv')
...
df.to_csv('DOWNLOADS/technology/sdwan/sdwan-sites.csv')
...
df.to_csv('DOWNLOADS/technology/sdwan/sdwan-links.csv')
...
df.to_csv('DOWNLOADS/technology/qos/policy-map.csv')
...
df.to_csv('DOWNLOADS/technology/qos/shaping.csv')
...
df.to_csv('DOWNLOADS/technology/qos/queuing.csv')
...
df.to_csv('DOWNLOADS/technology/qos/policing.csv')
...
df.to_csv('DOWNLOADS/technology/qos/priority-queuing.csv')
...
df.to_csv('DOWNLOADS/technology/qos/marking.csv')
...
df.to_csv('DOWNLOADS/technology/qos/random-drops.csv')
...
df.to_csv('DOWNLOADS/technology/oam/udld-neighbors.csv')
...
df.to_csv('DOWNLOADS/technology/oam/udld-interfaces.csv')
...
df.to_csv('DOWNLOADS/technology/cloud/virtual-machines.csv')
df.to_csv('DOWNLOADS/raw-tables/virtual-machines.csv')
print("The Cloud Virtual Machines table has downloaded successfully.")

# Download Cloud Virtual Machines Interfaces to the addressing folder:
df = pd.json_normalize(ipf.fetch_all('tables/cloud/virtual-machines-interfaces'))
df.to_csv('DOWNLOADS/technology/cloud/virtual-machines-interfaces.csv')
